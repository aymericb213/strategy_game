...
public class PlayerImageParser extends DefaultHandler{
    ...
    HashMap<String, ArrayList<Integer>> playerImages = new HashMap<String, ArrayList<Integer>>();
    ...
    public void startElement(String namespaceURI,String localName,String qname,Attributes atts) throws SAXException
    {
       ...
       if(qname == "SubTexture"){
           ...
           playerImages.put(atts.getValue("name"), new ArrayList<Integer>(Arrays.asList(
                   x,y,width,height
           )));
       }        
    }

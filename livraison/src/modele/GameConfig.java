...
public final class GameConfig {
    ...
    public void assignParameters() {
        ...
        GameConfig.BOMB_BASE_COUNT=parameters.get(5);	
        GameConfig.BOMB_DAMAGE=parameters.get(6);	
        GameConfig.BOMB_DELAY=parameters.get(7);	
        GameConfig.BOMB_VISIBILITY=parameters.get(8);	
        GameConfig.BOMB_PLANT_COST=parameters.get(9);	
        GameConfig.MINE_BASE_COUNT=parameters.get(10);	
        GameConfig.MINE_DAMAGE=parameters.get(11);	
        GameConfig.MINE_VISIBILITY=parameters.get(12);	
        GameConfig.MINE_PLANT_COST=parameters.get(13);	
        ...
        GameConfig.RIFLE_FIRE_COST=parameters.get(17);	
    }
}